...
class ObjectDetector:
    def __init__(self, model_name, labels='mscoco'):
    ...
    def print_model_info(self):
        print('Input: ')
        print(f'\t{self.model.signatures['serving_default'].inputs}')
        print('Output types:')
        print(f'\t{self.model.signatures['serving_default'].output_dtypes}')
        print('Output shapes:')
        print(f'\t{self.model.signatures['serving_default'].output_shapes}')
